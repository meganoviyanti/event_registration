                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <body>
                                              ...
                                              <div class="container text-center mt-4 mb-4" style="background-color: #509bf5">
                                                <div class="row align-items-start">
                                                    Silahkan Lakukan Login Untuk Melanjutkan Pada Halaman pembelian Tiket. Klik titik 3 Untuk Login!
                                                </div>
                                              </div>
                                              ...
                                              <nav class="navbar">
                                                ...
                                                <div class="navbar-options">
                                                  <div class="dropdown">
                                                    <button class="btn">...</button>                                                    <div class="dropdown-content">
                                                      <a href="{{ route ('masuk.index') }}">Login</a>
                                                    </div>
                                                  </div>
                                                </div>
                                              </nav>
